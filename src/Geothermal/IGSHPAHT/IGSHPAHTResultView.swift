...
struct IGSHPAHTResultView: View {
    ...
    init(calculator: IGSHPAHTCalculation) {
        ...
        self.inputData = [
            ...
            ("R(S)", formatNumber(calculator.soilResistance), "m ℃/W"),
            ...
            ("S(M)", formatNumber(calculator.trenchSpaceMulti), ""),
            ("P(M)", formatNumber(calculator.pipeDiameterMulti), ""),
        ]
        self.resultData = [
            ...
            ("R(P)", formatNumber(calculator.pipeThermalResistance, 1), "m ℃/W"),
            ("", "", ""),
            ("L(H.P)", formatNumber(calculator.heatingBoreholeLength, 1), "m"),
            ("L(C.P)", formatNumber(calculator.coolingBoreholeLength, 1), "m")
        ]
    }
    ...
    var body: some View {
        List {
            ...
            Section(header:
                ...
                HStack(spacing: 16) {
                    DataItemView(name: "Number of Trenches", value: String(noT), unit: "")
                        .frame(maxWidth: .infinity, alignment: .leading)
                    Spacer()
                    DataItemView(name: "Minimum Trench Length", value: formatNumber(len, 1), unit: "m")
                        .frame(maxWidth: .infinity, alignment: .leading)
                    Spacer()
                }
                .padding(.vertical, 0.25)
                ...
                HStack(spacing: 16) {
                    DataItemView(name: "Number of Pipes in Each Trench", value: String(noP), unit: "")
                        .frame(maxWidth: .infinity, alignment: .leading)
                    Spacer()
                    DataItemView(name: "", value: "", unit: "")
                        .frame(maxWidth: .infinity, alignment: .leading)
                ...
                VStack(alignment: .leading) {
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        Text("Minimum Trench Length:\n\(formatNumber(len, 1)) m ✕ \(noP) Pipes in \(noT) Trenches")
                            .font(.subheadline)
